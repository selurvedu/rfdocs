...
class ButtonModelAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):
        ...
        return urlpatterns + super(ButtonModelAdmin, self).get_urls()
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        return super(ButtonModelAdmin, self).change_view(request, object_id, form_url,
                                                         extra_context)
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        return super(ButtonModelAdmin, self).changelist_view(request, extra_context)
